    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers(HttpMethod.GET, "/recetas/**").hasAnyRole("USER", "ADMIN") // GET permitido para USER y ADMIN
                        .requestMatchers(HttpMethod.POST, "/recetas/**").hasRole("ADMIN") // POST permitido solo para ADMIN
                        .requestMatchers(HttpMethod.PUT, "/recetas/**").hasRole("ADMIN") // PUT permitido solo para ADMIN
                        .requestMatchers(HttpMethod.DELETE, "/recetas/**").hasRole("ADMIN") // DELETE permitido solo para ADMIN
